...
source=("https://github.com/C2N14/${_name}/archive/v${pkgver}.tar.gz"
       https://patch-diff.githubusercontent.com/raw/C2N14/AutomaThemely/pull/41.patch
        ${pkgname}.install
        ${pkgname}.service
        ${pkgname}.timer
)
sha256sums=('14e5100eb911ab8e5667a3358e1e7ed6540fd1a294ba4d451d4db480b08c3555'
            '83d754531187b79eaa97aeb0f6b090e4de46523f78beb5218c461b248b755625'
